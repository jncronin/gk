...
#if GK_ENABLE_NETWORK && GK_ENABLE_USB_NETWORK
#define __USB_NETWORK 1
#else
#define __USB_NETWORK 0
#endif

#define USB_VID     0xdeed
#define USB_PID     (0x474b + (__USB_NETWORK) + 2 * (GK_ENABLE_USB_MASS_STORAGE))
...
#define CONFIG_TOTAL_LEN (TUD_CONFIG_DESC_LEN + \
  ...
  TUD_RNDIS_DESC_LEN * (__USB_NETWORK) + \
