...
static const constexpr pin I2C7_SCL { GPIOD, 15, 10 };
...
void i2c_reset(bool irqs)
{
    ...
    I2C7_SDA.set_as_output(pin::OpenDrain);
    I2C7_SCL.set_as_output(pin::OpenDrain);
    I2C7_SDA.clear();
    I2C7_SCL.clear();
    ...
    I2C7_SDA.set_as_af(pin::OpenDrain);
    I2C7_SCL.set_as_af(pin::OpenDrain);
