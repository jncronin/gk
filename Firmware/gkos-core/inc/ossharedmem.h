...
class GKOS_FUNC(SharedMemoryGuard)
{
    public:
        GKOS_FUNC(SharedMemoryGuard)(const void *start, size_t len, bool will_read, bool will_write, bool is_dma = false);
        GKOS_FUNC(SharedMemoryGuard)() = delete;
        GKOS_FUNC(SharedMemoryGuard)(GKOS_FUNC(SharedMemoryGuard) &&) = delete;
        GKOS_FUNC(SharedMemoryGuard)(const GKOS_FUNC(SharedMemoryGuard) &) = delete;
        ~GKOS_FUNC(SharedMemoryGuard)();
