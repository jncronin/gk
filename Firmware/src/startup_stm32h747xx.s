...
/* Copy the itcm segment initializers from flash to SRAM */  
  ldr r0, =_sitcm
  ldr r1, =_eitcm
  ldr r2, =_sitcm_flash
  movs r3, #0
...
/* Copy the dtcm segment initializers from flash to SRAM */  
  ldr r0, =_sdtcm
  ldr r1, =_edtcm
  ldr r2, =_sdtcm_flash
  movs r3, #0
...
/* Zero fill sram bss segment */
  ldr r2, =_ssram_bss
  ldr r4, =_esram_bss
  movs r3, #0
  b LoopFillZerosram_bss

FillZerosram_bss:
  str  r3, [r2]
  adds r2, r2, #4

LoopFillZerosram_bss:
  cmp r2, r4
...
/* reset handler for CM4 */
    .section  .text.Reset_Handler_cm4
  .weak  Reset_Handler_cm4
  .type  Reset_Handler_cm4, %function
Reset_Handler_cm4:
  ldr   sp, =_ecm4_stack      /* set stack pointer */
  
  /* all init is already done */
  bl main_cm4

  bx lr
.size Reset_Handler_cm4, .-Reset_Handler_cm4

/* handlers for CM4 */
   .section  .isr_vec_cm4,"a",%progbits
  .type  g_pfnVectors_cm4, %object


g_pfnVectors_cm4:
  .word  _ecm4_stack
  .word  Reset_Handler_cm4
  ...
  .size  g_pfnVectors_cm4, .-g_pfnVectors_cm4
