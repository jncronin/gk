...
#define public_cALLOc    M_CONC(USE_MY_PREFIX, calloc)
#define public_fREe      M_CONC(USE_MY_PREFIX, free)
#define public_cFREe     M_CONC(USE_MY_PREFIX, cfree)
#define public_mALLOc    M_CONC(USE_MY_PREFIX, malloc)
#define public_mEMALIGn  M_CONC(USE_MY_PREFIX, memalign)
#define public_rEALLOc   M_CONC(USE_MY_PREFIX, realloc)
#define public_vALLOc    M_CONC(USE_MY_PREFIX, valloc)
#define public_pVALLOc   M_CONC(USE_MY_PREFIX, pvalloc)
#define public_mALLINFo  M_CONC(USE_MY_PREFIX, mallinfo)
#define public_mALLOPt   M_CONC(USE_MY_PREFIX, mallopt)
#define public_mTRIm     M_CONC(USE_MY_PREFIX, malloc_trim)
#define public_mSTATs    M_CONC(USE_MY_PREFIX, malloc_stats)
#define public_mUSABLe   M_CONC(USE_MY_PREFIX, malloc_usable_size)
#define public_iCALLOc   M_CONC(USE_MY_PREFIX, independent_calloc)
#define public_iCOMALLOc M_CONC(USE_MY_PREFIX, independent_comalloc)
...
#if __STD_C
extern Void_t*     sbrksram4(ptrdiff_t);
#else
extern Void_t*     sbrk();
#endif
#endif
...
SRAM4_DATA static struct malloc_state av_;  /* never directly referenced */
